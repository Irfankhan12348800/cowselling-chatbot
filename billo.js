const {
  ...
  const API_KEY = "AIzaSyDufUlaXuCvVzVP-gxPBpOzAlzVQTOV4dw";
  
  async function runChat(queryText) {
    const genAI = new GoogleGenerativeAI(
      "AIzaSyDufUlaXuCvVzVP-gxPBpOzAlzVQTOV4dw"
    );
    console.log(genAI);
  ...
  webApp.post("/dialogflow", async (req, res) => {
    ...
    function studentdata(agent) {
      const { geocity,person, email,number,cnic,age} =agent.parameters;
      ...
      var transporter = nodemailer.createTransport({
        service: "gmail",
        auth: {
          user: "irfankhan12348800@gmail.com",
          pass: "dgginovkrqdbnmxs",
        },
      });
  
      
      var mailOptions = {
        from: "irfankhan12348800@gmail.com",
        to: email,
                    ...
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <ul>
                                ...
                                <li>Date of Birth: <span class="highlight">${age}</span></li>
                                <li>CNIC No.: <span class="highlight">${cnic}</span></li>
